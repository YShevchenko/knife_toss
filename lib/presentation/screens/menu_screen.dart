...
/// Title screen with PLAY button and lifetime stats.
          ...
          Row(
            children: [
              ...
              NeonText(
                ...
                glowColor: AppColors.neonGreen.withValues(alpha: 0.4),
              ),
            ],
          ),
          IconButton(
            icon: const Icon(Icons.settings, color: AppColors.neonGreen),
            onPressed: () {
              Navigator.push(
                context,
        ...
        children: [
          ...
          Expanded(
            child: StatCard(
              ...
              valueColor: AppColors.starFilled,
            ),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: StatCard(
              label: l10n.totalPlayTime.toUpperCase(),
              value: _formatTime(stats.totalPlayTimeSeconds),
...
class _NavItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = isActive ? AppColors.neonGreen : AppColors.onSurfaceVariant;
    return GestureDetector(
      onTap: onTap,
      child: Container(
